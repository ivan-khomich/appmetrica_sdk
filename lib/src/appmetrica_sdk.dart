...
class AppmetricaSdk {
  ...
  Future<void> reportEvent({@required String name, Map<String, dynamic> attributes}) async {
    if (_apiKey == null) {
      throw 'The API key is not set';
    }
  ...
  Future<void> reportUserProfileCustomString({@required String key, @required String value}) async {
    if (_apiKey == null) {
      throw 'The API key is not set';
    }
    if (key == null) {
    ...
    await _channel.invokeMethod<void>('reportUserProfileCustomString', <String, dynamic>{
      'key': key,
      'value': value,
    });
  }
  ...
  Future<void> reportUserProfileCustomNumber({@required String key, @required double value}) async {
    if (_apiKey == null) {
      throw 'The API key is not set';
    }
    if (key == null) {
    ...
    await _channel.invokeMethod<void>('reportUserProfileCustomNumber', <String, dynamic>{
      'key': key,
      'value': value,
    });
  }
  ...
  Future<void> reportUserProfileCustomBoolean({@required String key, @required bool value}) async {
    if (_apiKey == null) {
      throw 'The API key is not set';
    }
    if (key == null) {
    ...
    await _channel.invokeMethod<void>('reportUserProfileCustomBoolean', <String, dynamic>{
      'key': key,
      'value': value,
    });
  }
  ...
  Future<void> reportUserProfileCustomCounter({@required String key, @required double delta}) async {
    if (_apiKey == null) {
      throw 'The API key is not set';
    }
    if (key == null) {
    ...
    await _channel.invokeMethod<void>('reportUserProfileCustomCounter', <String, dynamic>{
      'key': key,
      'delta': delta,
    });
  }
  ...
  Future<void> reportUserProfileUserName({@required String userName}) async {
    ...
    await _channel.invokeMethod<void>('reportUserProfileUserName', <String, dynamic>{
      'userName': userName,
    });
  }
  ...
  Future<void> reportUserProfileNotificationsEnabled({@required bool notificationsEnabled}) async {
    ...
    await _channel.invokeMethod<void>('reportUserProfileNotificationsEnabled', <String, dynamic>{
  ...
  Future<void> reportReferralUrl({@required String referral}) async {
    ...
    return await _channel.invokeMethod<String>('reportReferralUrl', <String, dynamic>{
      'referral': referral,
    });
  }

  Future<void> requestDeferredDeeplinkParameters(Future<dynamic> Function(MethodCall call) handler) async {
    if (_apiKey == null) {
      throw 'The API key is not set';
    }
    try {
